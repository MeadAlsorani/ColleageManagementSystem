...
namespace CMS_BackEnd.Application.Constants
{
    public class Menus
    {
        ...
        public Menus()
        {
            ...
            {
                new Menu{Route="/app/income",Title="Income transations",Icon="attach_money",Actions=new List<string>{"add","edit","delete" } },
                new Menu{Route="/app/outcome",Title="Outcome transaction",Icon="attach_money",Actions=new List<string>{"add","edit","delete" } },
            ...
            {
                new Menu{Route="/app/announcements",Title="Announcements",Icon="announcement",Actions=new List<string>{"add","edit","delete" } },
                new Menu{Route="/app/attendances",Title="Attendances",Icon="date_range",Actions=new List<string>{"add"} },
                new Menu{Route="/app/student",Title="Students",Icon="school",Actions=new List<string>{"add","edit","delete" } }
            });
        }
    }
